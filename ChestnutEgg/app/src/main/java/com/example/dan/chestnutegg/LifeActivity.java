...
public class LifeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button life_orc_in = (Button) findViewById(R.id.life_orc_in);

        life_orc_in.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent intent_lifetoorc = new Intent(LifeActivity.this,OrcActivity.class);
                startActivity(intent_lifetoorc);
            }
        });
